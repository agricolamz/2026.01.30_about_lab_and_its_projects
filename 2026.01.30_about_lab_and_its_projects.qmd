...
title: "Проекты Международная лаборатория языковой конвергенции"
...
# Диалектные и нестандартных варианты русского языка
...
- Но все равно объяснения будут носить разный характер:
  - диалектная вариативности будет объясняться процессами в истории русского языка, хотя и можно пытаться измерить степень влияния литературного варианта
...
- Данный эффект не был статистически значим в исследованиях выпадения предлога [@grishanova2025; @naccarato2025nonstandard; @yakovleva2025], мы обнаружили, что значимым фактором является фонетика и социолингвистика.
...
- [contribution manual](https://lingconlab.github.io/TALD_manual/)
...
В 2022 году был собран материал по 12 селам рутульского языка и оформлен [в атлас](https://lingconlab.github.io/rutul_dialectology/) с более чем 400 признаков. Анкеты на разные домены:
...
Кроме того, было несколько лексикографических экспедиций, в результате которых был составлен электронный словарь (версия [один](https://lingconlab.github.io/kina-rutul-dict/), версия [два](https://zhaaabka.github.io/kina-rutul-dict/index.html)). Каждый вход содержит:

- словоизменительную информацию,
- список возможных значений и сентенциальные примеры для каждого значения;
